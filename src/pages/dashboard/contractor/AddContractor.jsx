                 ...
                 <div className="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        Capital Type
                            ...
                            <div className="relative  mt-2">
                            <select name='type'   value={formValues.type} onChange={handleInputChange} className="block   appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"  required id="grid-gender">
                                    <option value="">Select</option>
