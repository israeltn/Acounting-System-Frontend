...
const ContractPaymentTableRow = ({ item, index }) => {
    ...
    return (
      <tr>
        ...
        <td className="px-6 py-4 whitespace-nowrap">
          <p className="text-xs font-medium text-gray-900">{item.payee}</p>
        </td>
        {/* <td className="px-6 py-4 whitespace-nowrap  ">
...
const AllPaymentVoucher = () => {
    ...
    const handleSearch = () => {  
      const url = baseURL +`/payment-vouchers/?search=${searchQuery}`;  
        fetch(url,{
          headers: {
...
export default AllPaymentVoucher;