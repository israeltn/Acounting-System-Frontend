...
const ApprovedContract = () => {
    ...
    const handleSearch = () => {  
      const url = baseURL +`/approved-contract-payment/?search=${searchQuery}`;  
        fetch(url,{
          headers: {
  ...
  return (
    ...
    <div className="md:flex items-center justify-between mt-2 mx-4">
                       ...
                       <div className="mb-4 w-[100px] flex space-x-2 justify-center items-center mr-5 ">
                               ...
                               <Link  to="/dashboard/cantractor-payment" >
