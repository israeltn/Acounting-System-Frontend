    ...
    <div>
      <main>
        ...
        <div className="mt-4 w-full  grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              ...
              <div className="md:flex w-full h-[350px] mt-8  gap-1">
                  <div className="shadow w-full h-auto  bg-white border-b-4  rounded-lg p-2 sm:p-6 xl:py-4 ">
                    <div className="flex w-full "> 
                        
                      <div className="flex W-auto  text-black text-base font-bold">
                            <div className='full W-auto '>
                            <div className="justify-center items-center text-center mb-4">
                            <h1 className="font-bold">Departmental Total Amount Requested</h1>
                          </div>
                           <div >
                              <Charts/>
                          </div> 
