...
const RetirementVoucher = () => {

  const [loading, setLoading] = useState(true);
  const url = baseURL +`/user-retirement/`;
  // const urlimg = imgURL;  
              ...
              <div class="md:flex items-center justify-between mx-4 mt-2">
                <div className="flex md:justify-start md:items-start text-center">
                      <h2 class="text-gray-600 mt-2 my-4 md:text-xl text-sm font-semibold text-center">
                        Latest Retirement Vouchers
                      </h2>
                
                </div>
                <div className="flex md:justify-end md:items-end space-x-2">
                    <Link  to="/userdashboard/retirementform"
                  className="flex mb-2 text-white   text-center w-[7rem] justify-center p-1 items-center bg-gradient-to-r from-pink-600 to-purple-800   border-gray-800 rounded-md">
                     <div className="flex justify-center items-center" >
                          
                          <span className="inline-block text-white  mr-1"> Add New  </span>                            
                          <BiMessageSquareAdd className="flex  w-[20px] text-white  text-center" />
                      </div>
                  </Link>
                  {/* <Link to="/userdashboard/chashadvanceform">
                  
                     <button className=" flex w-[7rem]  text-white h-7 justify-center items-center text-sm rounded-md shadow-md bg-red-600"> 
                        Add New 
                        <AiTwotoneFileAdd className="flex pl-1 w-[20px] text-white  text-center" />
                     </button>
                     </Link> */}
                </div>
              </div>
                  ...
                  <div className="shadow md:overflow-hidden overflow-x-auto border-b border-gray-200 sm:rounded-lg">
                    ...
                    {viewUsers.map((item,i) => (
                        <tr>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">                              
                          <div className="flex text-sm font-medium text-gray-900"><TbCurrencyNaira className="text-xl text-center"/> {item.amount_granted}</div>            
                           </td> 
                          <td className="px-6 py-4 whitespace-nowrap">                              
                          <div className="flex text-sm font-medium text-gray-900"><TbCurrencyNaira className="text-xl text-center"/> {item.amount_spent}</div>            
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="text-sm font-medium text-gray-900">{item.branch}</div>
                          </td>
...
export default RetirementVoucher;