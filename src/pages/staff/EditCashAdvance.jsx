...
const [userProfile, setUserProfile] = useState([]);
    ...
    const handleInputChange = (e) => {        
      ...
      const handleSubmit = async (e) => {
        ...
        //   _formData.append(key, formValues[key]);
        // }
        _formData.append('title', formValues.title);
        _formData.append('amount', formValues.amount);
        _formData.append('account_number', formValues.account_number);
        _formData.append('bank', formValues.bank);
        _formData.append('branch', formValues.branch);
        _formData.append('sort_code', formValues.sort_code);
        _formData.append('discription', formValues.discription);
        _formData.append('code', formValues.code);
        if(formValues.supporting_document!==''){
          _formData.append('supporting_documents', formValues.supporting_document,formValues.supporting_document.name);
        }
        
        
    
        try {
        const url = baseURL + /cashdvance/+id;    
          ...
          if (response.status == 200) {
            ...
            toast.success('CashAdvance Updated Successful!');
        ...
        const fetchCashAdvance = async () => {
          try {
            ...
            setFormValues({
              ...
              prev_documents:data.supporting_documents,
              supporting_document:''
            }); 
               ...
               <div className="container justify-center items-center max-w-screen-xl mx-auto">
                ...
                <form onSubmit={handleSubmit }  className="w-full  justify-center items-center max-w-screen-xl mx-auto ">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-8">
                        ...
                        <input type="number" name="city" value={staffNumber} className="appearance-none disabled: block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city"   />
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        ...
                        <input type="text" name="address" value={userProfile.address}  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password"   />
                        ...
                        <input type="text" name="department" value={userProfile.department}  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password"   />
                    ...
                    <div className="w-full md:w-1/2 px-3">
                        ...
                        <input type="text" name="designation" value={userProfile.degnisation}  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-phone"  />
                        <span className="pb-2 mb-2 text-sm text-red-600"></span>
                        </div>
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-city">
                        Station
                            ...
                            <input type="text" name="branch" value={userProfile.station}  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-city"   />
                            <span className="pb-2 mb-2 text-sm text-red-600">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-8">
                        ...
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                // value={formValues.supporting_documents}
                ...
                <div className="w-full item-center justify-center flex space-x-2 mb-6">
                    ...
                    <button  type="submit" disabled={isSubmitting} className=" mb-2  text-center w-1/6 justify-center py-2 px-2 items-center bbg-gradient-to-r from-green-600 to-green-800  text-white border-gray-800 rounded-md">
