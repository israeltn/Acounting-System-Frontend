...
const CashAdvanceList = () => {

    const [loading, setLoading] = useState(true);
    // const url = baseURL +`/user-cash-advance/`;
    // const urlimg = imgURL;  
    ...
    const handleSearch = () => {    
      ...
      const url = baseURL +`/user-cash-advance/?search=${searchQuery}`;
                    ...
                    <div className="shadow md:overflow-hidden overflow-x-auto border-b border-gray-200 sm:rounded-lg">
                        ...
                        <thead className="bg-gray-400">
                          <tr>
                           ...
                           Amount 
                            ...
                            <th
                              scope="col"
                              className="py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider"
                            >
                              Action
                            </th>
                      ...
                      {viewUsers.map((item,i) => (
                          <tr>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-xs font-medium text-gray-900">{item.account_number}</div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-xs font-medium text-gray-900">{item.bank}</div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-xs font-medium text-gray-900">{item.branch}</div>
                            </td>
                            ...
                            <Link to={`/userdashboard/edit-cashadvance/` +item.id} className="text-indigo-600  hover:text-indigo-900">
